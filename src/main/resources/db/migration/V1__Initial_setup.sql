...
CREATE TABLE goals (
    -- Corrigido: Adicionado DEFAULT para usar a sequência automaticamente
    id BIGINT NOT NULL PRIMARY KEY DEFAULT nextval('goals_seq'::regclass),
    name VARCHAR(255) NOT NULL,
    target_amount NUMERIC(19, 2) NOT NULL,
    -- Adicionado DEFAULT 0 para corresponder ao comportamento esperado da entidade
    ...
    -- Bônus: Garante a integridade dos dados no nível do banco, como na entidade
    CONSTRAINT goals_target_amount_check CHECK (target_amount >= 0)
);

-- Repete o mesmo padrão para as outras tabelas
